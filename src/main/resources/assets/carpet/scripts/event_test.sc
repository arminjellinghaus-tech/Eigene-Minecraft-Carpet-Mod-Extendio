...
__on_player_command(player, Invis_Mafia.command) ->
(
    print('');
    print('__on_player_command(player, Invis_Mafia.command)');
    print('Player '+player+' sent Invis_Mafia.command: '+Invis_Mafia.command)
);
